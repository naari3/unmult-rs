...
impl Plugin {
    ...
    fn legacy_render(&mut self, in_data: &InData, in_layer: ae::Layer, mut out_layer: ae::Layer) -> Result<(), ae::Error> {
    ...
    fn do_render(&self, in_data: &InData, in_layer: ae::Layer, mut out_layer: ae::Layer, in_pixel_format: PixelFormat, out_pixel_format: PixelFormat) -> Result<(), Error> {
